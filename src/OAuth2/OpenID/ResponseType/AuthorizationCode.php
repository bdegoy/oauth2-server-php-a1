...
class AuthorizationCode extends BaseAuthorizationCode implements AuthorizationCodeInterface
{
    ...
    public function getAuthorizeResponse($params, $user_id = null)
    {
        ...
        $result['query']['code'] = $this->createAuthorizationCode($params['client_id'], $user_id, $params['redirect_uri'], $params['scope'], $params['id_token'], $params['acr'], $params['code_challenge'], $params['code_challenge_method']);   //[pkce''][dnc91g]
     ...
     */
    public function createAuthorizationCode($client_id, $user_id, $redirect_uri, $scope = null, $id_token = null, $acr = null, $code_challenge = null, $code_challenge_method = null)  //[pkce''] [dnc91g]
    {
        $code = $this->generateAuthorizationCode();
        $this->storage->setAuthorizationCode($code, $client_id, $user_id, $redirect_uri, time() + $this->config['auth_code_lifetime'], $scope, $id_token, $acr, $code_challenge, $code_challenge_method);    //[pkce''] [dnc91g]
