...
class AuthorizeController extends BaseAuthorizeController implements AuthorizeControllerInterface
{
    ...
    protected function setNotAuthorizedResponse(RequestInterface $request, ResponseInterface $response, $redirect_uri, $user_id = null)
    {
        ...
        if ( strpos(\OAuth2\Storage\AuthorizationCodeInterface::RESPONSE_TYPE_CODE, $this->response_type) === false ) $response->set_in_fragment(true);    //[dnc142]
        //if (in_array($this->response_type, array(self::RESPONSE_TYPE_ID_TOKEN, self::RESPONSE_TYPE_ID_TOKEN_TOKEN))) $response->set_in_fragment(true);  //[dnc142]
     ...
     * @param RequestInterface $request
     * @param ResponseInterface $response
     * @param mixed $user_id  //[dnc49] : may be array
     * @return array
     */
    protected function buildAuthorizeParameters($request, $response, $user_id)
    {
        ...
        if ( $this->code_challenge ) $params['code_challenge'] = $this->code_challenge;
        if ( $this->code_challenge_method ) $params['code_challenge_method'] = $this->code_challenge_method;
    ...
    public function validateAuthorizeRequest(RequestInterface $request, ResponseInterface $response)
    {
        ...
        if ( $code_challenge ) $this->code_challenge = $code_challenge;
