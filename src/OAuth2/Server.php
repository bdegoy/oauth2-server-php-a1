...
UserInfoControllerInterface
{
    ...
    * @param mixed             $user_id       - Identifier of user who authorized the client //[dnc49] may be an array
    * @return ResponseInterface
    *
    * @see http://tools.ietf.org/html/rfc6749#section-4
    *
    ...
    */
    protected function createDefaultResourceController()
    {
        ...
        return new ResourceController($this->tokenType, $this->storages['access_token'], $this->storages['client_credentials'], $config, $this->getScopeUtil());
    }
    ...
    */
    protected function createDefaultUserInfoController()
    {
        ...
        return new UserInfoController($this->tokenType, $this->storages['access_token'], $this->storages['client_credentials'], $this->storages['user_claims'], $config, $this->getScopeUtil());
    } 
    ...
    */
    ...
    {
        // note : don't accept JWT access token
        ...
        if (!isset($this->storages['public_key'])) {
            throw new \LogicException('You must supply a storage object implementing OAuth2\Storage\PublicKeyInterface to use the Introspect server');
        }
        ...
        return new \OAuth2\OpenID\Controller\IntrospectController($this->tokenType, $this->storages['access_token'], $this->storages['client_credentials'], $this->storages['public_key'], $config, $this->getScopeUtil());
    } 
