    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function __construct($params = array())
    {
        $params = array_merge(array(
            ...
            'jti' => array(),
            'default_scope' => null,
            'reserved_scopes' => array('openid', 'offline_access'),     //[dnc131]
        ...
        $this->reservedScopes = $params['reserved_scopes'];    //[dnc131]
    ...
    public function setAuthorizationCode($code, $client_id, $user_id, $redirect_uri, $expires, $scope = null, $id_token = null, $acr = null, $code_challenge = null, $code_challenge_method = null) //[pkce'] [dnc91g]
    {
        $this->authorizationCodes[$code] = compact('code', 'client_id', 'user_id', 'redirect_uri', 'expires', 'scope', 'id_token', 'acr', 'code_challenge', 'code_challenge_method');  //[pkce']   [dnc91g]
    ...
    public function getReservedScopes($client_id = null)      //[dnc131]
    {
        return $this->reservedScopes;
    }
