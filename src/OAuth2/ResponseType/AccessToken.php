...
class AccessToken implements AccessTokenInterface
{
     ...
     */
    public function createAccessToken($client_id, $user_id, $scope = null, $includeRefreshToken = true, $acr = null)     //[dnc91g]
    {
        $token = array(
        ...
        $this->tokenStorage->setAccessToken($token["access_token"], $client_id, $user_id, $this->config['access_lifetime'] ? time() + $this->config['access_lifetime'] : null, $scope, $acr);  //[dnc91g]
