...
class Response implements ResponseInterface
{
    ...
    /** //[dnc142] 
    * true if parameters must be in fragment (hybrid/implicit flows) 
    * @var boolean
    */
    protected $in_fragment = false;    
    ...
    public function setRedirect($statusCode, $url, $state = null, $error = null, $errorDescription = null, $errorUri = null)
    {
        ...
        if ( $this->in_fragment ) { //[dnc142]
            // hybrid and implicit flows require params to be returned in the URL fragment.
            // @see https://openid.net/specs/openid-connect-core-1_0.html#rfc.section.3.3.2.5
            $url = str_replace("?", "#", $url);   // it's so simple it could be wrong ! 
        }
    ...
    /** //[dnc142] 
    * @param mixed $set  true if parameters must be in fragment (hybrid/implicit flows) 
    */
    public function set_in_fragment( $set ) 
    {
        $this->in_fragment = (bool)$set;        
    }
